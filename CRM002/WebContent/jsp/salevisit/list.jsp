...
<head>
    ...
    <SCRIPT language=javascript>
        ...
        function deleteConfirm(cust_name,path) {
            if (confirm("确认要删除"+cust_name+"？")) {
                alert("删除成功");
                            ...
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    ...
                                    <TD>
                                        ...
                                        <input type="button"
                                               value="选择客户"
                                               onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list2?select=true','','width=600,height=300')"/>
                                    </TD>
